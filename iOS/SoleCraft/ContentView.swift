    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                TextField("Hide Type", text: $draft.hideType, axis: .vertical)
                    .accessibilityIdentifier("field_hideType")
                TextField("Pattern", text: $draft.pattern, axis: .vertical)
                    .accessibilityIdentifier("field_pattern")
                TextField("Stitch Count", text: $draft.stitchCount, axis: .vertical)
                    .accessibilityIdentifier("field_stitchCount")
